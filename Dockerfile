...
RUN yum install -y wget && wget https://packages.endpointdev.com/rhel/7/os/x86_64/endpoint-repo.x86_64.rpm
RUN yum update -y && yum localinstall -y  endpoint-repo.x86_64.rpm
